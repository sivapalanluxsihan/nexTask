...
const models: TsoaRoute.Models = {
  ...
  ApiResponse_AuthData_: {
    ...
    properties: {
      ...
      data: {
        dataType: 'union',
        subSchemas: [{ ref: 'AuthData' }, { dataType: 'enum', enums: [null] }],
        required: true,
      },
      error: {
        dataType: 'union',
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    async function TaskController_getTask(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTaskController_getTask,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function TaskController_createNewTask(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTaskController_createNewTask,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function TaskController_updateExistingTask(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTaskController_updateExistingTask,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function TaskController_deleteExistingTask(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsTaskController_deleteExistingTask,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function PingController_getMessage(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPingController_getMessage,
          request,
          response,
        });
